...
/** Screen component for secondary screen under "Conferences" */
const WhyILoveConferencesScreen: FC = () => {
  ...
  const useFullSizeImage = useMemo(
    () => displaySize === 'MOBILE' || displaySize === 'SMALL',
    [displaySize],
  );
    ...
    <Screen ref={ref} resetScroll={resetScroll}>
      <div className="padding-med">
        ...
        <p>
          ...
          <a href="https://cuwip.physics.berkeley.edu/">an upcoming conference</a>{' '}
          targeting underrepresented undergraduate students in physics and astronomy.
          Entirely clueless as to what such a conference would entail but intrigued at the
          opportunity to spend a whole weekend with like-minded students similar to
          myself, I applied to attend.
        </p>
        ...
        <p>
          ...
          <a href="https://www.aps.org/programs/women/workshops/cuwip.cfm">
            called CUWiP
          </a>
          , again during both my sophomore and senior years. During my senior year and
          after I graduated, I helped lead the organizational effort alongside a faculty
          committee to host the 2018 conference at my home institution. Among other
          responsibilities, I built and maintained{' '}
        ...
        <p>
          I love how conferences can make a full auditorium of people buzz with
          anticipation and excitement for the first keynote speaker of the day. I love how
          conferences bolster a community by highlighting just how incredible the members
        ...
        <p>
          However, as an able-bodied, financially stable white woman who was able to
          attend college, I consider myself one of the lucky ones. We must acknowledge
          that there continue to exist many{' '}
          <a href="https://www.brookings.edu/articles/unequal-opportunity-race-and-education/">
            systemic barriers
          </a>{' '}
          that disadvantage certain members of our communities and often prohibit them
          from attending or participating in conferences. We must also recognize that
          conference organizers are granted a fairly unique superpower: the power to lift
          up speakers from marginalized backgrounds and declare them as experts in their
          field, just by inviting them to speak. As of 2018,{' '}
        ...
        <p>
          Despite the continued need for improvement, I am encouraged by the
          ever-so-slowly shifting landscape at conferences, from the emergence of
          conferences for{' '}
          ...
          ,{' '}
          <a href="https://github.com/mmcelaney/tech-conferences-w-childcare">
            childcare
          </a>
          , live captioning, and other means of making their conferences more accessible.
        </p>
        <p>
          I believe that conferences have something to offer everyone, so conferences
          should <em>be</em> for everyone. My aspiration is to keep equity and inclusion
          at the forefront of the conversation when it comes to improving the conference
          experience and to continue emphasizing ways conference organizers can prioritize
          making their events more equitable and accessible for everyone.
        </p>
      </div>
    </Screen>
  );
