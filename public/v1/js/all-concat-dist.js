...
(function () {
   ...
   function addProjects() {
      ...
      $(projData.projects).each(function () {
         ...
         screenOverlays += "\"); opacity: 0;'>\n";
         screenOverlays += "<div class='overlay-caption'>" + curr.caption + "</div>\n</div>\n";
         // add project card and info to projects lists
         var output = "<li class='project-card " + curr.sname + "'>\n";
      ...
      // add screenshots and project lists
      $('.overlays-container').html(screenOverlays);
   ...
   $('body').on('mouseenter', '.project-card', function () {
      ...
      if (!mobile) {
         // Get project sname
         var sname = $(this).attr('class').split(" ")[1];
         // Get screenshot view container
         var cont = $('.overlays-container .screen-overlay.' + sname);
